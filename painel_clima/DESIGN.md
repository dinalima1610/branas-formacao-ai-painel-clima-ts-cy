...
legal_note: "Educational design reference only. Claude and Anthropic are trademarks of Anthropic, PBC. This project is not affiliated with, endorsed by, sponsored by, or officially connected to Anthropic, and it does not use official Anthropic logos or proprietary brand assets."
