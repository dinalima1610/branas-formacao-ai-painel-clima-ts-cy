...
- [ ] Rules em @.agents/rules verificadas
...
[Pesquisar as rules na pasta @.agents/rules que se encaixem e se apliquem a esta especificação técnica e listá-las abaixo:]
