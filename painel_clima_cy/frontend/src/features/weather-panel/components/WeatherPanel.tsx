    ...
    <section className="w-full bg-canvas px-4 py-10 text-body sm:px-6 lg:px-8" aria-labelledby="weather-panel-title">
      <div className="mx-auto flex max-w-6xl flex-col gap-6">
        <header className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            <p className="text-sm font-medium uppercase tracking-[0.12em] text-primary">Clima agora</p>
            <h1 className="mt-2 font-display text-4xl font-normal tracking-tight text-ink md:text-5xl" id="weather-panel-title">
